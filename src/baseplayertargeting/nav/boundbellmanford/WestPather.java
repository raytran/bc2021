package baseplayertargeting.nav.boundbellmanford;
...
public class WestPather{
    ...
    static void pathTo(MapLocation targetLoc, BoundingBox box) throws GameActionException {
        ...
        if (targetLoc != null){
            ...
            if (last != -1){
                ...
                if (rc.canMove(rc.getLocation().directionTo(target)) && box.isContained(target)){
