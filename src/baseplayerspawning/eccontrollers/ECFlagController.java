...
import baseplayerspawning.flags.BoundarySpottedInfo;
...
public class ECFlagController implements ECController {
    ...
    private void setFlags() throws GameActionException {
        ...
        if (ec.getThisRoundNeutralEcSpottedInfo().isPresent()){
            ...
            if(rc.getRoundNum() <= 16 / rc.sensePassability(rc.getLocation())){
                rc.setFlag(Flags.encodeGoScout(rc.getRoundNum()));
            }
        }
    }
}
