...
import dlmoreram012221_01.ds.LinkedListNode;
import dlmoreram012221_01.eccontrollers.*;
import dlmoreram012221_01.flags.NeutralEcSpottedInfo;
...
public class BotEnlightenment extends BotController {
    ...
    private boolean isEnemyMuckraker = false;
    ...
    public BotController run() throws GameActionException {
        ...
        System.out.println("DL MORE RAM 012221_01");
    ...
    public boolean isEnemyMuckraker() {
        return isEnemyMuckraker;
    }

    public void setEnemyMuckraker(boolean enemyMuckracker) {
        isEnemyMuckraker = enemyMuckracker;
    }
