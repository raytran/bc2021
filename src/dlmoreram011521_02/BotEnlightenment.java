...
import dlmoreram011521_02.ds.LinkedListNode;
import dlmoreram011521_02.eccontrollers.*;
import dlmoreram011521_02.flags.NeutralEcSpottedInfo;
...
public class BotEnlightenment extends BotController {
    ...
    public BotController run() throws GameActionException {
        System.out.println("DL MORE RAM 011521_02");
        // Sense danger level
        senseController.run();
