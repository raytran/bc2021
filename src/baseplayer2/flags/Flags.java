 ...
 * Generate baseplayer2.flags with the generate* methods
 * Decode baseplayer2.flags with decodeFlag()
 */
public class Flags {
    public static final int REBROADCAST_ROUND_LIMIT = 400;
    // All baseplayer2.flags are 24 bit integers
    ...
    // NOTE: flag-type is currently 3 bits; 8 baseplayer2.flags max
    // [23:21]                    [20:17]                    [16:0]
