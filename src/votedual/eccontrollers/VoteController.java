package votedual.eccontrollers;

import votedual.BotEnlightenment;
...
public class VoteController implements ECController {
     ...
     */
    public VoteController(RobotController rc, BotEnlightenment ec, int delta, double epsilon) {
        this.rc = rc;
        this.ec = ec;
        this.delta = delta;
    ...
    public void run() throws GameActionException {
        ...
        int currentInfluence = rc.getInfluence(); // ec.getVoteBudget();
        int[] activeCounts;
        int[] activeWins;
        int activeValue;
        int prevValue;
        ...
        int bidAmount = (updateFlat ? (int) (this.votePercent * (double) (currentInfluence-activeValue)/100 + activeValue)
                : (int) (activeValue * (double) (currentInfluence-this.voteFlat)/100) +this.voteFlat);
        ...
        } else if (bidAmount > currentInfluence) {
