...
public class Flags {
    ...
    // [23:21]      [20:17]        [16:13]
    // flagType     timestamp      role
    public static int encodeRobotRole(int roundnum, RobotRole role){
        int flag = encodeFlagBase(FlagType.ROBOT_ROLE, roundnum);
        flag ^= role.ordinal() << 13;
        return flag;
    }
    public static RobotRole decodeRobotRole(int flag){
        return RobotRole.values[(flag >> 13) & 0b1111];
    }
