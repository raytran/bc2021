...
public class ECFlagController implements ECController {
    ...
    private void setFlags() throws GameActionException {
        ...
        if (ec.getThisRoundNeutralEcSpottedInfo().isPresent()){
            rc.setFlag(Flags.encodeNeutralEcSpotted(FlagAddress.ANY, ec.getThisRoundNeutralEcSpottedInfo().get().location, ec.getThisRoundNeutralEcSpottedInfo().get().conviction));
